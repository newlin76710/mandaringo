...
<title>资源共享 - Mandarin GO 快乐学中文</title>
		...
		<div class="nav">
			...
			<div class="list">
				<ul class="toolbar">
					...
					<li><a href="./resource" class="now">资源共享</a></li>
...
<div id="mainboxf" class="clearfix" style="background:#fff;">
	<div class="tit" style="padding-bottom:20px;">
		<h1>活动学习单</h1>
		<h6>Activity Sheets</h6>
	</div>
	<ul class="study-list">
		<li>
			<a href="resource/a08.jpg" class="viewimg" target="_blank"><img src="images/resource/a08.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">熊熊着色单</p>
				<a href="" class="download" download="resource/a08.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a07.jpg" class="viewimg" target="_blank"><img src="images/resource/a07.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">灯笼绘画单</p>
				<a href="" class="download" download="resource/a07.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a06.jpg" class="viewimg" target="_blank"><img src="images/resource/a06.jpg" width="70%" title="点击看大图"/></a>
		  <div class="viewtit">
				<p style="background:#f0f0f0">练习写写看</p>
				<a href="" class="download" download="resource/a06.jpg"></a>
			</div>
		</li>
		<li style="margin-right:0;">
			<a href="resource/a05.jpg" class="viewimg" target="_blank"><img src="images/resource/a05.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">水果剪贴板</p>
				<a href="" class="download" download="resource/a05.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a04.jpg" class="viewimg" target="_blank"><img src="images/resource/a04.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">颜色连连看</p>
				<a href="" class="download" download="resource/a04.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a03.jpg" class="viewimg" target="_blank"><img src="images/resource/a03.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">水果的颜色</p>
				<a href="" class="download" download="resource/a03.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a02.jpg" class="viewimg" target="_blank"><img src="images/resource/a02.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">水果手指谣</p>
				<a href="" class="download" download="resource/a02.jpg"></a>
			</div>
		</li>
		<li style="margin-right:0;">
			<a href="resource/a01.jpg" class="viewimg" target="_blank"><img src="images/resource/a01.jpg" width="70%" title="点击看大图"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">我最喜欢的水果</p>
...
<div id="mainboxf" class="clearfix" style="background:#f2f2f2;">
	<div class="tit" style="padding-bottom:20px;">
		<h1>儿歌童谣</h1>
		<h6>Children’s Chinese Learning Songs</h6>
	</div>
	<ul class="study-list">
		<li>
	...
	<ul class="study-list">
		<li>
			...
			<div class="viewtit" style="padding-bottom:0;">
				<p style="border-bottom:none; margin:0;">中文手指谣</p>
			</div>
			</a>
		</li>
		<li>
			...
			<div class="viewtit" style="padding-bottom:0;">
				<p style="border-bottom:none; margin:0;">传统民俗童玩</p>
			</div>
			</a>
		</li>
	</ul>
...
<div id="MyDiv5" class="white_content">
	<div class="white_box">
		...
		<iframe width="900" height="470" src="https://www.youtube.com/embed/PC0w5nP9aDo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="background:#cccccc;"></iframe></iframe>
	</div>
</div>
