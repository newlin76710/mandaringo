...
<title>資源共享 - Mandarin GO 快樂學中文</title>
		...
		<div class="nav">
			...
			<div class="list">
				<ul class="toolbar">
					...
					<li><a href="source" class="now">資源共享</a></li>
...
<div id="mainboxf" class="clearfix" style="background:#fff;">
	...
	<ul class="study-list">
		<li>
			<a href="resource/a08.jpg" class="viewimg" target="_blank"><img src="images/resource/a08.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">熊熊著色單</p>
				<a href="" class="download" download="resource/a08.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a07.jpg" class="viewimg" target="_blank"><img src="images/resource/a07.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">燈籠繪畫單</p>
				<a href="" class="download" download="resource/a07.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a06.jpg" class="viewimg" target="_blank"><img src="images/resource/a06.jpg" width="70%" title="點擊看大圖"/></a>
		  <div class="viewtit">
				<p style="background:#f0f0f0">練習寫寫看</p>
				<a href="" class="download" download="resource/a06.jpg"></a>
			</div>
		</li>
		<li style="margin-right:0;">
			<a href="resource/a05.jpg" class="viewimg" target="_blank"><img src="images/resource/a05.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">水果剪貼板</p>
				<a href="" class="download" download="resource/a05.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a04.jpg" class="viewimg" target="_blank"><img src="images/resource/a04.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">顏色連連看</p>
				<a href="" class="download" download="resource/a04.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a03.jpg" class="viewimg" target="_blank"><img src="images/resource/a03.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">水果的顏色</p>
				<a href="" class="download" download="resource/a03.jpg"></a>
			</div>
		</li>
		<li>
			<a href="resource/a02.jpg" class="viewimg" target="_blank"><img src="images/resource/a02.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">水果手指謠</p>
				<a href="" class="download" download="resource/a02.jpg"></a>
			</div>
		</li>
		<li style="margin-right:0;">
			<a href="resource/a01.jpg" class="viewimg" target="_blank"><img src="images/resource/a01.jpg" width="70%" title="點擊看大圖"/></a>
			<div class="viewtit">
				<p style="background:#f0f0f0">我最喜歡的水果</p>
	...
	<ul class="study-list">
		<li>
			...
			<div class="viewtit" style="padding-bottom:0;">
				<p style="border-bottom:none; margin:0;">中文手指謠</p>
			</div>
			</a>
		</li>
		<li>
			...
			<div class="viewtit" style="padding-bottom:0;">
				<p style="border-bottom:none; margin:0;">傳統民俗童玩</p>
			</div>
			</a>
		</li>
	</ul>
