...
<div id="head">
	<div class="navbox">
		<div class="nav">
			...
			<div class="list">
				<ul class="toolbar">
					<li><a href="../td/" class="now">首頁</a></li>
	...
	<ul>
		<li>
			<div class="noword clearfix">
				...
				<p>重視兒童全人教育及各大領域的發展，<br/>讓兒童沈浸於快樂的學習環境中。</p>
			</div>
		...
		<li>
			<div class="noword clearfix">
				...
				<p>課程內容從幼兒的生活經驗出發，涵蓋<br/>符合幼兒身心發展的十大精選主題。</p>
			</div>
...
<div id="mainboxb" class="clearfix">
	<div class="frameimg"><img src="images/img01t.png" /></div>
</div>
<div id="mainboxc" class="clearfix">
	<div class="tit">
		<h1>精選主題</h1>
		<h6>Featured Themes</h6>
		<p class="fs18 lh30">依據學齡前兒童的生活經驗，由基本認知及認識自我開始，到與校園生活、認識社區、職業等社會建立聯結，透過不同的主題來設計基礎教材。<br/>
教材以主題式課程的方式為構架，其設計以兒童的日常生活經驗出發，設計貼近兒童能力指標的課程活動，使兒童在學習語言的同時，兼顧身心發展。</p>
	</div>
	<ul>
		<li>
